...
def summary(cfg: dict):
    ...
    print(f"  curl -x http://{lan_ip}:3128 -s https://api.ipify.org && echo    # IPv4 test")
    print(f"  curl -x http://{lan_ip}:3128 -s https://api6.ipify.org && echo   # IPv6 test")
    print("")
    print("📋 Or in your applications, use this proxy:")
    print(f"  HTTP Proxy: {lan_ip}:3128")
